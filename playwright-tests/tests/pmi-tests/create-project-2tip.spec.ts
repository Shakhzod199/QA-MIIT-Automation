...
//
// This spec covers the "Yo'l xaritaga kiritilgan loyihalar" project type. It is
// the same form as create-project-1tip with two differences: it has an extra
// "Soha guruhi" select, and it has no start/end date fields.
// ---------------------------------------------------------------------------
  ...
  test("creates a 'Yo'l xaritaga kiritilgan' project and gets 200 on save", async ({
    ...
    await page
      .locator(".n-tree-node-content", {
        // Apostrophe-free substring — the live label uses a curly "Yo‘l".
        hasText: "xaritaga kiritilgan loyihalar",
      })
      .first()
      .click();
    await expect
