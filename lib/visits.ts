 ...
 * This is history, not presence — a day with logins doesn't mean those users
 * are still active. See lib/presence.ts / components/OnlineUsers.tsx for "who's online now".
 */
export async function getDailyVisits(days = 7): Promise<DailyVisits[]> {
